...
export default function Textbox({ sendMessage, messageInput, setMessage }: TextboxProps)  {
  return (
    <div className="flex flex-row justify-between bg-[#474747] rounded-3xl px-2 py-1 w-[95%]  md:w-[80%] lg:w-[70%] ">
      <input onChange={(e) => setMessage(e.target.value)} className="bg-transparent focus-visible:outline-0 text-sm text-white ml-3 w-full" type="text" placeholder="Enter message here..." value={messageInput}/>
